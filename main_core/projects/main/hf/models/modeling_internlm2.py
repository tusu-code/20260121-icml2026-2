...
class InternLM2PreTrainedModel(PreTrainedModel, GenerationMixin):
...
class InternLM2ForCausalLM(InternLM2PreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        ...
        if past_key_values is not None:
            # Robustness: some transformers versions / decoding paths may pass a
            # past_key_values structure whose tensors are None (e.g., (None, None)).
    ...
    def chat(
        ...
        meta_instruction: str = 'You are an AI assistant whose name is InternLM.\n'
                                '- InternLM is a conversational language model. It is designed to be helpful, honest, and harmless.\n'
                                '- InternLM can understand and communicate fluently in the language chosen by the user (e.g., English).',
        **kwargs,
    ):
