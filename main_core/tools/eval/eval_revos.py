...
# This script lives at: Main/tools/eval/eval_revos.py -> repo root is two levels up.
import sys
...
# Default 128 workers is often too aggressive on shared servers.
# Allow overriding via env var: REVOS_EVAL_WORKERS=16 python ...
NUM_WOEKERS = int(os.environ.get("REVOS_EVAL_WORKERS", "16"))
...
def eval_queue(q, rank, out_dict):
    ...
    while True:
        ...
        # Some videos/expressions might be missing in prediction dict (e.g. partial eval / resume).
...
if __name__ == '__main__':
    ...
    parser.add_argument("--foreground_mask_path", type=str, default="data/video_datas/revos/mask_dict_foreground.json")
