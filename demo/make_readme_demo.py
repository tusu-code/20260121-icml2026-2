...
for Sa2VA-style video grounding/segmentation.
...
Example:
  PYTHONPATH=. python tools/demo/make_readme_demo.py \
    ...
    --model_path ByteDance/Sa2VA-InternVL3-2B \
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--model_path", type=str, default="ByteDance/Sa2VA-8B", help="HF repo id or local HF dir.")
...
def run_demo(
    ...
    # `predict_forward` is provided by Sa2VA HF models with trust_remote_code=True
